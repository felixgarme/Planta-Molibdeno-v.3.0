...
this.procedures["casco"] = casco;
this.procedures["lentes"] = lentes;
this.procedures["ropa"] = ropa;
this.procedures["auditiva"] = auditiva;
this.procedures["respirador"] = respirador;
this.procedures["zapatos"] = zapatos;
this.procedures["bloqueador"] = bloqueador;
this.procedures["sticker"] = sticker;
...
function sticker() {
    ...
    Function('app', 'v3d', 'puzzles', 'VARS', 'PROC', 'mostrar("Object0021");')(appInstance, v3d, PL, VARS, PROC);


    Function('app', 'v3d', 'puzzles', 'VARS', 'PROC', 'mostrar("sticker");')(appInstance, v3d, PL, VARS, PROC);


    Function('app', 'v3d', 'puzzles', 'VARS', 'PROC', 'mostrar("Object004");')(appInstance, v3d, PL, VARS, PROC);


    Function('app', 'v3d', 'puzzles', 'VARS', 'PROC', 'mostrar("Object002");')(appInstance, v3d, PL, VARS, PROC);

    tweenCamera('HeadCam', 'HeadPos', 2, function() {}, 0);
}

// Describe this function...
function casco() {
    tweenCamera('HeadCam', 'HeadPos', 1, function() {
...
// Describe this function...
function lentes() {
    tweenCamera('FaceCam', 'HeadPos', 1, function() {

        Function('app', 'v3d', 'puzzles', 'VARS', 'PROC', 'mostrar("LentesSeguridadHombre");')(appInstance, v3d, PL, VARS, PROC);
...
// Describe this function...
function ropa() {
    tweenCamera('BodyCam', 'BodyPos', 1, function() {

        Function('app', 'v3d', 'puzzles', 'VARS', 'PROC', 'mostrar("Chaleco");')(appInstance, v3d, PL, VARS, PROC);
...
function auditiva() {
    tweenCamera('FaceCam', 'HeadPos', 1, function() {
        ...
        Function('app', 'v3d', 'puzzles', 'VARS', 'PROC', 'mostrar("Object005");')(appInstance, v3d, PL, VARS, PROC);


        Function('app', 'v3d', 'puzzles', 'VARS', 'PROC', 'mostrar("Object006");')(appInstance, v3d, PL, VARS, PROC);


        Function('app', 'v3d', 'puzzles', 'VARS', 'PROC', 'mostrar("ProtectorAuditivoHombre");')(appInstance, v3d, PL, VARS, PROC);
...
function respirador() {
    tweenCamera('FaceCam', 'HeadPos', 1, function() {
        ...
        Function('app', 'v3d', 'puzzles', 'VARS', 'PROC', 'mostrar("Box002");')(appInstance, v3d, PL, VARS, PROC);


        Function('app', 'v3d', 'puzzles', 'VARS', 'PROC', 'mostrar("Box001");')(appInstance, v3d, PL, VARS, PROC);


        Function('app', 'v3d', 'puzzles', 'VARS', 'PROC', 'mostrar("11_MascaraSiliconada");')(appInstance, v3d, PL, VARS, PROC);
...
// Describe this function...
function zapatos() {
    tweenCamera('FeetCam', 'FeetPos', 1, function() {}, 1);
}

// Describe this function...
function bloqueador() {
    tweenCamera('BodyCam', 'BodyPos', 1, function() {}, 1);
}
    ...
    'import("../Recursos/js/imports/import.js");')))(appInstance, v3d, PL, VARS, PROC);
